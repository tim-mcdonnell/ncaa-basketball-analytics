import aiohttp
from typing import Dict, Any, Optional, Union, Callable, TypeVar, Type, Awaitable
import logging
import asyncio
...
class AsyncClient:
    ...
    def _create_get_function(self, endpoint: str, params: Optional[Dict[str, Any]], 
                           headers: Optional[Dict[str, str]]) -> Callable[[], Awaitable[Dict[str, Any]]]:
        """
    ...
    async def post(
        ...
        """
        # Use the retry decorator created during initialization
        return await self._retry_decorator(self._create_post_function(endpoint, json, params, headers))()
