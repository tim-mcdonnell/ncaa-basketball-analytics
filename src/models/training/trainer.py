...
class ModelTrainer:
    ...
    def __init__(
        ...
        self.device = torch.device(
            training_params.get("device", "cpu")
        ...
        self.metrics_to_track = training_params.get(
            "metrics_to_track", ["accuracy", "mse", "point_spread_accuracy"]
        )
    ...
    def _get_optimizer(
        ...
        optimizer_map = {
            ...
            "sgd": optim.SGD(self.model.parameters(), lr=learning_rate, weight_decay=weight_decay),
            "rmsprop": optim.RMSprop(
                self.model.parameters(), lr=learning_rate, weight_decay=weight_decay
            ),
        }
        return optimizer_map.get(
            optimizer_name.lower(), optim.Adam(self.model.parameters(), lr=learning_rate)
        )
    ...
    def train_epoch(self) -> float:
        ...
        if all_predictions and all_targets:
            ...
            epoch_metrics = compute_metrics(predictions, targets, self.metrics_to_track)
