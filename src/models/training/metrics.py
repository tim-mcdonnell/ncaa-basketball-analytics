...
class TrainingMetrics:
    ...
    def get_best_epoch_metrics(self) -> Dict[str, float]:
        ...
        metrics = {"best_val_loss": self.best_val_loss, "best_epoch": self.best_epoch}
    ...
    def get_learning_curve_data(self) -> Dict[str, List[float]]:
        ...
        data = {"train_loss": self.train_losses, "val_loss": self.val_losses}
...
def compute_point_spread_accuracy(predictions: torch.Tensor, targets: torch.Tensor) -> float:
    """
