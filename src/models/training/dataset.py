...
class GameDataset(Dataset):
    ...
    def __init__(
        ...
        if target_column == "home_score_margin" and target_column not in self.data.columns and calculate_score_margin:
            if "home_score" in self.data.columns and "away_score" in self.data.columns:
                ...
                raise ValueError("Cannot calculate home_score_margin: home_score or away_score missing")
