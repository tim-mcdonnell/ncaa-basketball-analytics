...
from src.models.mlflow.tracking import MLflowTracker, get_mlflow_client, setup_mlflow_tracking
...
class TestMLflowTracker:
    ...
    def test_tracker_initialization(self, model_config, mock_mlflow):
        ...
        tracker = MLflowTracker(
            experiment_name="test_experiment", model_config=model_config, run_name="test_run"
        )
    ...
    def test_log_metrics(self, model_config, mock_mlflow):
        ...
        # Create metrics
        metrics = {"train_loss": 0.25, "val_loss": 0.30, "accuracy": 0.85}
